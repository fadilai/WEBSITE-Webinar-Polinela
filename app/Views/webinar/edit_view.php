        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo site_url('/data/update2'); ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="col">
                        <label for="formFile" class="form-label"><b>Gambar Kiri</b></label>
                        <input class="form-control" type="file" id="formFile" name="gambar2" value ="/assets/gambar2/<?= $gambar2 ?>">
                        <?php
                        if (!empty($gambar2)) {
                    ...
                    <div class="col">
                        <label for=""><b>Tanggal</b></label>
                        <input type="date" name="tanggal2" class="form-control" value="tanggal2" value="<?= $tanggal2; ?>" >
            ...
            <div class="card-body">
                <form action="<?php echo site_url('/data/update3'); ?>" enctype="multipart/form-data" method="post">
                    <div class="form-group justify-center">
                        <label for=""><b>Judul</b></label>
                        <input type="text" name="judul3" class="form-control" placeholder="Judul" value="<?= $judul3; ?>">
                    ...
                    <div class="col">
                        <label for="formFile" class="form-label"><b>Gambar Kiri</b></label>
                        <input class="form-control" type="file" id="formFile" name="gambar3" value ="/assets/gambar3/<?= $gambar3 ?>">
                        <?php
                        if (!empty($gambar3)) {
                            echo '<img src="'.base_url("assets/gambar3/$gambar3").'" width="150">';
                        }
                    ?>
                    </div>
                    ...
                    <div class="col">
                        <label for=""><b>Tanggal</b></label>
                        <input type="date" name="tanggal" class="form-control" value="tanggal3" value="<?= $tanggal3; ?>" >

                    <div class="">
                        <label for="exampleFormControlTextarea1" class="form-label"><b>Masukkan Isi Gambar Kiri</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="teks" value="<?= $teks3; ?>" >  </textarea>
                    </div>
                    </div>
