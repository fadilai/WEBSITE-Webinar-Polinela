    ...
    <section id="blog">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="post-img text-center">
                <img src="/assets/gambar/<?= $data['gambar'] ?>" alt="" class="img-fluid">
              </div>
              ...
              <div class="container">
                  ...
                  <div class="card mb-3" style="max-width: 68rem;">
                    <div class="card-body">
                        <h5 class="card-title"><b>Tema Semninar:</b>  <h4><?= $data['judul'] ?></h4></h5>
                    </div>
                    <ul>
                      <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2020-01-01"><?= $data['tanggal'] ?></time></a></li>
                    </ul>
                    <div class="content">
                      <p>
                      <?= $data['teks'] ?>
                    ...
                    <a href="/data/registry"onclick="" class="btn btn-success">Daftar</a>
                  </div>
