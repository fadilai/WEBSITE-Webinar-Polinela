    ...
    <div class="info d-flex align-items-center nav-light">
      <div class="container">
        ...
        <div class="card-body">
          ...
          <div class="col-md-6">
			<form action="<?= base_url('semnasabsen/save'); ?>" method="POST">
				<?= csrf_field(); ?>
				<div class="absen">				
					<form>
					<div class="mb-3">
          ...
          <div class="mb-3">
						<label for="exampleInputNamaLengkap" class="form-label">Tanggal</label>
						<input type="date" class="form-control" id="exampleInputNamaLengkap" name="tanggal">
					</div>
